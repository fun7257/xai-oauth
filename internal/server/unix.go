...
// Parent directory is created with 0700; the socket file is chmod 0600.
// An existing socket file at path is removed first (stale daemon).
func ListenUnix(path string) (net.Listener, error) {
	...
	// Tighten dir perms even if it already existed with a looser mode.
